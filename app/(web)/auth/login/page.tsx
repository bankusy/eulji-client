    ...
    return (
        <div className="min-h-screen bg-(--background) flex flex-col justify-center items-center p-4">
            <div className="w-full max-w-sm">
                ...
                <div className="bg-(--background-subtle) border border-(--border-subtle) rounded-xl p-6">
                    ...
                    <button
                        onClick={handleLogin}
                        className="w-full h-11 bg-white hover:bg-gray-50 text-black border border-gray-200 flex items-center justify-center gap-3 transition-all font-medium text-sm"
                    >
